...
key.setGlobalKey('M-l', function (ev, arg) {
    ext.exec("tab_last", arg);
}, "view last tab", true);

// key.setCaretKey('M-l', function (ev) {
//     ext.exec("focus_last_selected_tab", arg);
// }, 'Select last selected tab', false);
...
key.setViewKey(["z", "m" ], function (ev, arg) { ext.exec("text-zoom-enlarge", arg); }, 'zoom in text zoom', false);
key.setViewKey(["g", "i" ], function (ev, arg) { ext.exec("focus-to-the-first-textarea", arg); }, 'focus to input box', false);

key.setViewKey('f', function (ev, arg) { ext.exec("hok-start-foreground-mode", arg); }, 'Start foreground hint mode', true);

key.setViewKey('F', function (ev, arg) { ext.exec("hok-start-background-mode", arg); }, 'Start background hint mode', true);

key.setViewKey(';', function (ev, arg) { ext.exec("hok-start-extended-mode", arg); }, 'Start extended hint mode', true);
...
key.setCaretKey(["z", "m" ], function (ev, arg) { ext.exec("text-zoom-enlarge", arg); }, 'zoom in text zoom', false);
key.setCaretKey(["g", "i" ], function (ev, arg) { ext.exec("focus-to-the-first-textarea", arg); }, 'focus to input box', false);

key.setCaretKey('f', function (ev, arg) { ext.exec("hok-start-foreground-mode", arg); }, 'Start foreground hint mode', true);

key.setCaretKey('F', function (ev, arg) { ext.exec("hok-start-background-mode", arg); }, 'Start background hint mode', true);

key.setCaretKey(';', function (ev, arg) { ext.exec("hok-start-extended-mode", arg); }, 'Start extended hint mode', true);
